...
const TrustCard = ({ icon, value, label, description, index }: TrustCardProps) => (
  <motion.div
    ...
    whileHover={{ y: -4 }}
    className="flex flex-col gap-3 rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-zinc-900/5 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:shadow-zinc-900/30"
  >
