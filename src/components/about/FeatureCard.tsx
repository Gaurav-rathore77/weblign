...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => (
  <motion.div
    ...
    whileHover={{ y: -3 }}
    className="group flex gap-4 rounded-xl border border-zinc-100 bg-white p-4 shadow-xs transition-shadow duration-300 hover:shadow-md hover:shadow-zinc-900/5"
  >
