...
const AboutHero = () => {
  return (
    <section className="relative min-h-[70dvh] overflow-hidden bg-gradient-to-b from-white via-zinc-50/40 to-white pb-16 pt-32 sm:pb-20 sm:pt-40 dark:from-zinc-950 dark:via-zinc-900/30 dark:to-zinc-950">
